...
def getSiteListInfo(page):
    response = session.get(
        'https://plan.qyer.com/api/v3/recommend/getpoilist?city_id=11690&range=1&page=' + str(page) + '&type=0')
    return response.json()


def getDetail(poiId):
    response = session.get('https://plan.qyer.com/api/v3/poi/getpoidetail?plan_id=23193396&poi_id=' + str(poiId))
    return response.json()
    ...
    for page in range(100):
        ...
        for site in sites['data']:
            try:
                ...
                picture_path = 'data-hangzhou-0716/pics/{}-{}'.format(site['cn_name'], sid)
                ...
                continue
    with open('data-hangzhou-0716/hangzhou-sites-0716.json', 'w', encoding='utf-8') as file:
