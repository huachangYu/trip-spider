...
def getCookies():
    cookies = {}
    cookieStr = "_qyeruid=CgIBAV8NN6CFAkFfTsScAg==; new_uv=1; new_session=1; _guid=R0b40500-b6fb-271d-94af-b68ed13bcab7; PHPSESSID=831fbb4b3dc64d681b6b8ee4d1bda7a3; __utmc=253397513; ql_guid=QL5e39c7-8c94-4c3b-aa5a-a540a666959a; source_url=https%3A//plan.qyer.com/trip/create%3Fvcode%3D4173f4c4a00e50ce547e276f3424af85%26; isnew=1594701754400; __utmz=253397513.1594791716.6.2.utmcsr=google|utmccn=(organic)|utmcmd=organic|utmctr=(not%20provided); __utma=253397513.833478904.1594701746.1594812078.1594862807.10; ql_created_session=1; ql_stt=1594862806674; ql_vts=11; __utmt=1; plan_token=759aed1d4d472b543b849e0686299193; plan_code=V2YJYFFnBz9TYVI8CmQNNg; ql_seq=4; __utmb=253397513.8.9.1594863975171"
    # cookieStr = "_qyeruid=CgIBAV8NN6CFAkFfTsScAg==; new_uv=1; new_session=1; _guid=R0b40500-b6fb-271d-94af-b68ed13bcab7; PHPSESSID=831fbb4b3dc64d681b6b8ee4d1bda7a3; __utmc=253397513; ql_guid=QL5e39c7-8c94-4c3b-aa5a-a540a666959a; source_url=https%3A//plan.qyer.com/trip/create%3Fvcode%3D4173f4c4a00e50ce547e276f3424af85%26; isnew=1594701754400; __utmz=253397513.1594791716.6.2.utmcsr=google|utmccn=(organic)|utmcmd=organic|utmctr=(not%20provided); __utma=253397513.833478904.1594701746.1594797621.1594800276.8; ql_created_session=1; ql_stt=1594802558047; ql_vts=9; __utmt=1; plan_token=94390c6c76b3447183603ede36fb7ad1; plan_code=V2YJYFFnBz9TZ1I8CmUNOA; ql_seq=10; __utmb=253397513.20.9.1594804068511"
...
def getSiteListInfo(page):
    response = session.get(
        'https://plan.qyer.com/api/v3/recommend/getpoilist?city_id=12068&range=1&page=' + str(page) + '&type=0')
    return response.json()


def getDetail(poiId):
    response = session.get('https://plan.qyer.com/api/v3/poi/getpoidetail?plan_id=23195388&poi_id=' + str(poiId))
    return response.json()
    ...
    for page in range(100):
        ...
        for site in sites['data']:
            try:
                ...
                picture_path = 'data-changsha-0716/pics/{}-{}'.format(site['cn_name'], sid)
                ...
                continue
    with open('data-changsha-0716/changsha-sites-0716.json', 'w', encoding='utf-8') as file:
