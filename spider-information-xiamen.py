...
def getSiteListInfo(page):
    response = session.get(
        'https://plan.qyer.com/api/v3/recommend/getpoilist?city_id=12486&range=1&page=' + str(page) + '&type=0')
    return response.json()


def getDetail(poiId):
    response = session.get('https://plan.qyer.com/api/v3/poi/getpoidetail?plan_id=23196303&poi_id=' + str(poiId))
    return response.json()
    ...
    for page in range(100):
        ...
        for site in sites['data']:
            try:
                ...
                picture_path = 'data-xiamen-0716/pics/{}-{}'.format(site['cn_name'], sid)
                ...
                continue
    with open('data-xiamen-0716/xiamen-sites-0716.json', 'w', encoding='utf-8') as file:
